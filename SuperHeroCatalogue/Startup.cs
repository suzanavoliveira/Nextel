...
namespace SuperHeroCatalogue
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<SuperHeroCatalogueDb>(options => options.UseSqlServer(@"Data Source=DESKTOP-G0UKP8N\SQLEXPRESS;Initial Catalog=SuperHeroCatalogue;Integrated Security=True"));
